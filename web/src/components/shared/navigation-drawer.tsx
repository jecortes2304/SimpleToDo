...
import {AlertManager} from "../alerts/alert-manager.tsx";
import {ClipboardIcon, CommandLineIcon, FolderIcon, HomeIcon} from "@heroicons/react/24/solid";
import {DocumentTextIcon, UsersIcon} from "@heroicons/react/16/solid";
import useAuthStore from "../../store/auth-store.ts";

const DrawerNavigation: React.FC = () => {
    const { t } = useTranslation();
    const {user} = useAuthStore(); // 1 => Admin/Root
