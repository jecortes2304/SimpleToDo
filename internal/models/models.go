...
type OAuthIdentity struct {
	...
	Provider  string `gorm:"size:32;not null;uniqueIndex:idx_oauth_provider_subject;uniqueIndex:idx_oauth_user_provider"`
	Subject   string `gorm:"size:255;not null;uniqueIndex:idx_oauth_provider_subject"`
}
