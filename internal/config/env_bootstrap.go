...
func EnsureEnvInteractive() error {
	...
	fields := []envField{
		...
		{Key: "GOOGLE_CLIENT_ID", Prompt: "Google OAuth client ID", Default: "", Optional: true, Validate: func(s string) error { return nil }},
		{Key: "GOOGLE_CLIENT_SECRET", Prompt: "Google OAuth client secret", Default: "", Optional: true, Secret: true, Validate: func(s string) error { return nil }},
...
func LoadEnvFromAppDir() error {
	...
	if (googleClientID == "") != (googleClientSecret == "") {
		return errors.New("GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET must either both be set or both be empty")
	}
