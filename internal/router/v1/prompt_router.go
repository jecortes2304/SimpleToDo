...
func (pc *PromptController) createPrompt(c echo.Context) error {
	var body request.UpsertPromptRequest
...
func PromptRouters(db *gorm.DB, v1 *echo.Group) {
	...
	// @Accept json
	// @Produce json
	// @Param payload body request.UpsertPromptRequest true "Create Prompt payload"
	// @Success 201 {object} response.PromptItemResponse
	...
	// @Param search query string false "Search by title, description or system prompt"
	// @Success 200 {object} response.PromptsResponse
	// @Failure 400 {object} response.StandardResponseError
	// @Failure 401 {object} response.StandardResponseError
	// @Failure 403 {object} response.StandardResponseError
	...
	// @Success 200 {object} response.PromptItemResponse
	// @Failure 400 {object} response.StandardResponseError
	// @Failure 401 {object} response.StandardResponseError
	// @Failure 403 {object} response.StandardResponseError
	...
	// @Security BearerAuth
	// @Param id path int true "Prompt ID"
	// @Param payload body request.UpsertPromptRequest true "Update Prompt payload"
	// @Success 200 {object} response.PromptItemResponse
	// @Failure 400 {object} response.StandardResponseError
	// @Failure 401 {object} response.StandardResponseError
	// @Failure 403 {object} response.StandardResponseError
